...
caffe_root = '/home/shiyan/caffe-master-20160520/'  
...
source = caffe_root+subfile_name+'/mnist_train_lmdb_mean.binaryproto'
des = caffe_root+subfile_name+'/mnist_train_lmdb_mean.npy'
