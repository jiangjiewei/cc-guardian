...
#model=['weighted-fine-resnet-128','7','8','9','10']
normal_file='normal'
...
cnn='fine-ResNet-101/two_classification_problem'
model='weighted-fine-resnet-128-10'
train_caffemodel=['1','2','4','6','7','8','9','10','11','12','13','14','16','18','20','200']
#train_caffemodel=['1','12','3','4','5','6','7','8','9','10','11','2','13','14','15','16','17','18','19','20','24','28','34','38','40','42','46','50','100','200']


#train_caffemodel=['46','50','100','200']
#cnn='cnn'
...
for i in range(0,16):
    print i
    get_result_five_fold_cross(model,normal_file,recurrence_file,surgery_file,image,cnn,train_caffemodel[i])
    #i=i+1
