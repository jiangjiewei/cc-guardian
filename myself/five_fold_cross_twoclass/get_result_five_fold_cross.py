# -*-  encoding:utf-8  -*-
def get_result_five_fold_cross(normal_file,recurrence_file,surgery_file,image,cnn):
	import numpy as np
	import matplotlib.pyplot as plt
	import os,types

	caffe_root = '/home/shiyan/桌面/github/cc-guardian-master/'
	import sys
	...
	MODEL_FILE = caffe_root+'myself/'+cnn+'/deploy-101.prototxt'
	PRETRAINED = caffe_root+'myself/'+cnn+'/'+'caffe_resnet101_train_iter_2000.caffemodel'+''
	...
	RESULT_FILE=caffe_root+'myself/'+cnn+'/caffe_resnet101_test_result'+'.txt'
