...
class CostSoftmaxWithLossLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
  explicit CostSoftmaxWithLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "CostSoftmaxWithLoss"; }
